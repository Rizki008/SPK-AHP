		...
		<div class="col-md-12 mb-lg-0 mb-4">
			<div class="card-body p-3">
				<div class="row">
					...
					<?php echo form_open('AnalisisDummy/hitung_absen') ?>
					<div class="row">
						<div class="col">
							...
							<div class="input-group input-group-outline mb-3">
								<select name="bulan" id="analisis" class="form-control">
									...
									<?php foreach ($periode as $key => $value) {
										$cek_analisis = $this->M_analisis->cek_analisis_absensi($value->bulan, $value->tahun);
									?>
						...
						foreach ($bulantahun as $key => $value) { ?>
							<tr>
								...
								<td class="align-middle text-center text-sm">
									<a href="<?= base_url('AnalisisDummy/hasil_absen/' . $value->bulan . '/' . $value->tahun) ?>" class="btn bg-gradient-info btn-sm">
										Lihat Hasil
									</a>
								</td>
							</tr>
